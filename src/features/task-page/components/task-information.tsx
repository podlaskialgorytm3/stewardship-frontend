...
export const TaskInformation: React.FC<{ taskInfo: TaskPageResponse }> = ({
  taskInfo,
}) => {
  ...
  return (
    <div className="mt-5 flex flex-col items-center">
      ...
      <div className="w-[700px] flex flex-wrap justify-center">
        <TaskElement size={600}>
          <p>
            {formatDateTime(taskInfo.taskInfo.startDate)} -{" "}
            {formatDateTime(taskInfo.taskInfo.endDate)}
          </p>
        </TaskElement>
        ...
        <TaskElement size={400}>
          ...
          <img
            src={taskInfo.taskInfo.assignedBy.img}
            alt={taskInfo.taskInfo.assignedBy.name}
            className="mt-5 w-12 h-12 rounded-full border-2 border-dark object-cover"
          />
        </TaskElement>
      </div>
    </div>
