        ...
        <div className="flex flex-col items-center">
          {(data || !isLoading) && (
            <img
              ...
              alt="profile"
              className="w-[200px] h-[200px] rounded-full object-cover border-[#7e007e] border-[3px] mt-10 cursor-pointer"
              onClick={() => handleImageClick()}
            />
          )}
          <p
            className="text-3xl mt-10 font-bold cursor-pointer"
          ...
          <p
            className="text-xl mt-10 hover:font-bold cursor-pointer"
